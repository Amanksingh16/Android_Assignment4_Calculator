package com.example.amansingh.calculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case R.id.nine : result.setText(result.getText()+"9");
                break;
            case R.id.eight : result.setText(result.getText()+"8");
                break;
            case R.id.seven : result.setText(result.getText()+"7");
                break;
            case R.id.six : result.setText(result.getText()+"6");
                break;
            case R.id.five : result.setText(result.getText()+"5");
                break;
            case R.id.four : result.setText(result.getText()+"4");
                break;
            case R.id.three : result.setText(result.getText()+"3");
                break;
            case R.id.two : result.setText(result.getText()+"2");
                break;
            case R.id.one : result.setText(result.getText()+"1");
                break;
            case R.id.zero :
